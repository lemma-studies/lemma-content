---
title: '基督徒行為'
description: 'Christian Behaviour (Chinese Simplified edition) — Chinese (Simplified) edition, under the Lemma Press imprint.'
sidebar:
  order: 0
head:
  - tag: meta
...
banner:
  content: |
    <strong>Coming</strong> — Chinese (Simplified) edition of John Bunyan's <em>Christian Behaviour</em> (1663). CC-BY 4.0. See the <a href="https://github.com/lemma-studies/lemma-content/blob/master/docs/adr/2026-08-12-translation-studies.md">translation-studies ADR</a> for the design.
---

# 基督徒行為

*Christian Behaviour (Chinese Simplified edition)*

**Language:** Chinese (Simplified)
**Source:** John Bunyan, *Christian Behaviour* (London, 1663) — EEBO-TCP CC0 transcript A30128.0001.001

The Chinese (Simplified) edition is sourced from the modern-English pilot (`bunyan-christian-behaviour-en`). Chapter 1 draft (v0.1) exists in the FDT working repo; further chapters follow the pipeline in `~/.claude/playbooks/playbook-translation-study.md`. Ships after native-Chinese (Simplified)-reader review circle feedback per ADR §10 sequencing.
